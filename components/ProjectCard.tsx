...
export const ProjectCard = ({ title, description, color }: Props) => {
  return (
    <Link
      ...
      className={`flex flex-col border-2 items-center border-black md:py-10 w-64 md:max-w-1/4 my-3 mx-10 rounded-xl cursor-pointer hover:border-amber-900 duration-300 ${color} p-4`}
    >
